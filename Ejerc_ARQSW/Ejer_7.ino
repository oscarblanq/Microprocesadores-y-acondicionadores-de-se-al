/* ================================== EJERCICIO 7 ======================================
 * Complete el programa del fichero Ejer_7_int_cola.ino para enviar a una tarea 
 * mediante una cola los bytes recibidos en la UART0 y leídos en su rutina de atención 
 * a la interrupción. La tarea los enviará de nuevo a través de la UART0. Utilice el
 * monitor serie para enviar y visualizarlos los datos.
 * Acciones a realizar:
 ...
 * 4. Leer los datos de la cola en la tarea lee_cola, mediante la función xQueueReceive 
 * y enviarlos al monitor mediante uart_write_bytes
=====================================================================================*/
...
static void  IRAM_ATTR uart_intr_handle(void *arg)
{
  ...
  while(rx_fifo_len){
    ...
    xQueueSend(xQueue, &rxbuf, portMAX_DELAY);
...
void lee_cola(void *pvParameter)
{
   ...
   while(1) { 
      ...
      uart_write_bytes(UART_NUM_0, Rx, TAM_COLA);
   }
}
